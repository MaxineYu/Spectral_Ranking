##-----------------------------------------------------------------    ##  ###Uncomment lines 153-156 when we want orale estimator.###
NN = 500; B = 500; n = 50; n1 = n*0.2; n2 = n*0.5
L = 36000
...
##theta1[1:10] = theta1[1:10]+0.2; theta1[11:50] = theta1[11:50]-10*0.2/40                               ## top-10 items ##
##-----------------------------------------------------------------    ## 
theta2 = seq(6,2,length=n); theta2 = theta2-mean(theta2)                                           ## null hypothesis ##
#theta2 = theta1; theta2[1:9] = theta2[1:9]+0.2; theta2[11:n] = theta2[11:n]-0.2*9/40             ## uncomment this when null hypothesis ##
theta2 = theta1; theta2[6] = theta1[20]; theta2[20] = theta1[6]    
theta2[7] = theta1[21]; theta2[21] = theta1[7]                              ## alternative hypothesis ##  
theta2[8] = theta1[22]; theta2[22] = theta1[8]                              ## alternative hypothesis ##   
theta2[9] = theta1[23]; theta2[23] = theta1[9]                              ## alternative hypothesis ##  
theta2[10] = theta1[24]; theta2[24] = theta1[10]                              ## alternative hypothesis ##                     
##-----------------------------------------------------------------    ##
statset = numeric(NN)
...
##-----------------------------------------------------------------    
##-----------------------------------------------------------------    
##pihat = pihatMLE                                                    ###Uncomment lines 153-156 when we want orale estimator.
...
set1 = index[(R.left.one<=10)]
print(set1)
set2 = index[(R.left.one2<=10)]
print(set2)
statset[ww] = 1*(length(intersect(set1,set2))<10)
write.csv(statset,"statset.csv")
}
mean(statset)  #Output of EC5 
